...
//       // Include filters in query parameters if they have values
//       const queryParams = {
//         page,
//         limit: 20,
//         levels: "1",
...
//         ...(filterStatus && { status: filterStatus }),
//         ...(filterjoinDate && { joinDate: filterjoinDate }),
//       };
...
//       // Calculate total self business (sum of self_investment)
//       const totalSelfBusiness = response?.data.reduce((sum, user) => {
//         return sum + (user?.self_investment || 0);
//       }, 0);

//       // Calculate total team business (sum of business)
//       const totalTeamBusiness = response?.data.reduce((sum, user) => {
//         return sum + (user?.business || 0);
//       }, 0);
...
//     setFilterjoinDate("");
//     setFilterStatus("");
//     FetchTeam(1); // Reset the page to 1 and fetch data without filters
//   }
...
//               <Col lg="2" md="4" xs="6">
//                 <button onClick={() => FetchTeam(currentPage)}>Search</button>
//               </Col>
//               <Col lg="2" md="4" xs="6">
//                 <button onClick={filterReset}>Reset</button>
//               </Col>
...
//                 Self Business:{" "}
//                 <span>
//                   {selfBussTransaction || 0} {companyData?.currency}
//                 </span>
//               </h4>
//               <h4>
//                 Team Business:{" "}
//                 <span>
//                   {teamBussTransaction || 0} {companyData?.currency}
//                 </span>
//               </h4>
//             </div>
//           </div>
...
//               <tbody>
//                 {directTeamData?.map((x, i) => (
//                   <tr key={x.id || i} className="teamRow">
//                     <td>{i + 1}</td>
//                     <td
//                       onClick={() => {
//                         FetchTeam(x?.uid, "", "0");
...
//               </tbody>
//             </table>
//             {directTeamData?.length === 0 ? <p>No history found</p> : ""}
//           </div>
